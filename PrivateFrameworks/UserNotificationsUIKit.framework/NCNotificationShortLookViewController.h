...
@interface NCNotificationShortLookViewController : NCNotificationViewController <NCNotificationViewControllerObserving, PLClickPresentationInteractionManagerDelegate, PLClickPresentationInteractionPresenting, PLExpandedPlatterPresentationControllerDelegate, PLViewControllerAnimatorDelegate, UIDragInteractionDelegate, UIPointerInteractionDelegate> {
...
- (bool)dismissPresentedViewControllerAnimated:(bool)arg1 completion:(id /* block */)arg2;
