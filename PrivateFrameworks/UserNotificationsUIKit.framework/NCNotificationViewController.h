...
@interface NCNotificationViewController : UIViewController <NCNotificationCustomContentDelegate, PLContentSizeCategoryAdjusting, PLExpandedPlatterPresentationControllerDelegate> {
