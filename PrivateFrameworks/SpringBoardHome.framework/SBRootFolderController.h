...
@interface SBRootFolderController : SBFolderController <SBFramewiseInteractiveTransitionAnimatorDelegate, SBHAddWidgetSheetViewControllerDelegate, SBHIconRootViewProviding, SBHStackConfigurationViewControllerAppearanceDelegate, SBHWidgetDragHandling, SBHWidgetSheetViewControllerPresenter, SBRootFolderPageStateTransitioning, SBRootFolderViewDelegate, SBSearchGestureObserver, SBViewControllerTransitionContextDelegate, UIGestureRecognizerDelegate> {
    ...
    <BSInvalidatable> * _iconImageViewControllerKeepStaticForPageManagementDismissalAssertion;
    <BSInvalidatable> * _iconImageViewControllerKeepStaticForPageManagementVisibleAssertion;
...
@property (nonatomic, retain) <BSInvalidatable> *iconImageViewControllerKeepStaticForPageManagementDismissalAssertion;
@property (nonatomic, retain) <BSInvalidatable> *iconImageViewControllerKeepStaticForPageManagementVisibleAssertion;
...
- (id)iconImageViewControllerKeepStaticForPageManagementDismissalAssertion;
- (id)iconImageViewControllerKeepStaticForPageManagementVisibleAssertion;
...
- (void)setIconImageViewControllerKeepStaticForPageManagementDismissalAssertion:(id)arg1;
- (void)setIconImageViewControllerKeepStaticForPageManagementVisibleAssertion:(id)arg1;
...
- (void)togglePageManagementUIWithCompletionHandler:(id /* block */)arg1;
