...
@interface SBRootFolderView : SBFolderView <SBDockViewDelegate, SBFRemoteBasebandLoggingObserver, _UISettingsKeyObserver> {
    ...
    <SBRootFolderViewLayoutManager> * _transitioningSpecialLayoutManager;
...
@property (nonatomic, retain) <SBRootFolderViewLayoutManager> *transitioningSpecialLayoutManager;
...
- (void)setTransitioningSpecialLayoutManager:(id)arg1;
...
- (id)transitioningSpecialLayoutManager;
