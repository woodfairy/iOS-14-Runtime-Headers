...
@interface SBHIconLibraryTableViewController : SBHTableViewController <PTSettingsKeyObserver, SBHLibraryChildViewController, SBHSearchResultsUpdating, SBHTableViewIconLibraryObserver, SBIconObserver, SBIconViewObserver, UIGestureRecognizerDelegate, UITableViewDragDelegate> {
