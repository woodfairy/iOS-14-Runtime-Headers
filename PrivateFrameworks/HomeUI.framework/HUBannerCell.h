...
@interface HUBannerCell : UICollectionViewCell <HUBannerCellProtocol, HUGridCellProtocol> {
    bool  _cellContentsHidden;
    UIButton * _continueButton;
    UILabel * _descriptionLabel;
    UIButton * _dismissButton;
    <HUBannerCellDelegate> * _dismissButtonDelegate;
    UIView * _footerView;
...
@property (nonatomic) <HUBannerCellDelegate> *dismissButtonDelegate;
...
- (void)setDismissButtonDelegate:(id)arg1;
