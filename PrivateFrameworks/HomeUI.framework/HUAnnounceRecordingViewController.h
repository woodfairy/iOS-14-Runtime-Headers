...
@interface HUAnnounceRecordingViewController : UIViewController <HFAccessoryObserver, HFAudioRecorderDelegate, HFMediaObjectObserver, UIGestureRecognizerDelegate> {
    ...
    NSLayoutConstraint * _errorStatusLabelCenterYConstraint;
...
@property (nonatomic, retain) NSLayoutConstraint *contentViewLeadingConstraint;
...
@property (nonatomic, retain) NSLayoutConstraint *errorStatusLabelCenterYConstraint;
...
- (id)errorStatusLabel;
- (id)errorStatusLabelCenterYConstraint;
...
- (void)setContentViewLeadingConstraint:(id)arg1;
...
- (void)setErrorStatusLabelCenterYConstraint:(id)arg1;
