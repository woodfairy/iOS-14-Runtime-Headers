...
@property (nonatomic, retain) HUDashboardNavigationButton *navigationAnnounceTextButton;
...
- (id)navigationAnnounceTextButton;
...
- (void)setNavigationAnnounceTextButton:(id)arg1;
