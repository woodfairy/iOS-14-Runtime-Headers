...
@property (nonatomic) bool morphShouldMatchMove;
@property (nonatomic) bool morphShouldShowBlackCurtainOverSource;
@property (nonatomic) double morphSourceClipDuration;
@property (nonatomic) double morphSourceUnclipDuration;
@property (nonatomic) double morphTargetClipDuration;
