...
@interface SBIconController : UIViewController <APUIAppPredictionViewControllerDelegate, BBObserverDelegate, FBSDisplayLayoutPublisherObserving, MCProfileConnectionObserver, PTSettingsKeyObserver, SBAlertItemsControllerObserver, SBApplicationRestrictionObserver, SBAssistantObserver, SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBFOverlayObserving, SBFloatingDockControllerDelegate, SBHIconManagerDelegate, SBHLibraryViewControllerObserver, SBHSidebarProviderDelegate, SBHomeScreenIconTransitionAnimatorDelegate, SBHomeScreenOverlayControllerDelegate, SBHomeScreenSpotlightDismissalDelegate, SBHomeScreenTodayViewControllerDelegate, SBIconAnimationContaining, SBIconModelApplicationDataSource, SBLayoutStateTransitionObserver, SBProactiveHomeScreenSuggestionProviderObserver, SBProactiveHomeScreenUsageObserverDelegate, SBRootFolderControllerAccessoryViewControllerDelegate, SBRootFolderPageStateObserver, SBSearchGestureObserver, SBTodayViewControllerDelegate, SPUIRemoteSearchViewDelegate, SPUISearchBarDelegate, UIGestureRecognizerDelegate, WGWidgetGroupViewControllerDelegate> {
    ...
    <BSInvalidatable> * _pageManagementWallpaperScaleAssertion;
...
@property (nonatomic, retain) <BSInvalidatable> *pageManagementWallpaperScaleAssertion;
...
- (id)pageManagementWallpaperScaleAssertion;
...
- (void)setPageManagementWallpaperScaleAssertion:(id)arg1;
