...
+ (bool)addMethod:(SEL)arg1 typeEncoding:(id)arg2 implementation:(int (*)arg3 toInstances:(bool)arg4;
...
+ (int (*)replaceImplementationOfMethod:(id)arg1 with:(int (*)arg2 useInstance:(bool)arg3;
+ (void)swizzle:(id)arg1 with:(id)arg2 onInstance:(bool)arg3;
+ (bool)swizzleByName:(id)arg1 with:(id)arg2 onInstance:(bool)arg3;
+ (void)swizzleBySelector:(SEL)arg1 with:(SEL)arg2 onInstance:(bool)arg3;
